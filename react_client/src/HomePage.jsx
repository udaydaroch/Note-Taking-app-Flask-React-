...
function HomePage() {
  const [showNoteTakingPage, setShowNoteTakingPage] = useState(false);
    ...
    <div className="home-page">
      {!showNoteTakingPage && (
        <div className="card">
          ...
          <br/>
          <Button buttonName="TakeNotes" onClick={handleTakeNotes} />
        </div>
      )}
      ...
      {!showNoteTakingPage && (
        <div className="card">
          ...
          <br/>
          <Button buttonName={"Contact-friend"} buttonText="Button 2" />
        </div>
      )}
      ...
      {showNoteTakingPage && <NoteTakingPage />}
    </div>
  );
}
